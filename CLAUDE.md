...
src/app.js           the game participants run: map (Google Map Tiles API or OSM fallback), GPS, HUD, location sheet (arrival → challenges → summary), clues & suspects screen, start screen; exposes hooks
