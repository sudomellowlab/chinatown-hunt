...
src/play.js          game rules: stepping through a location (Back/Next/Finish), the starting challenge, one-location-at-a-time, the timed clues reveal, validation: pure
